...
Fill this in with your own writing. Every slot below is currently filled with
text I invented as a placeholder — none of it should ship.

Write however you like. Don't worry about formatting, length, apostrophes,
quotes, dashes, or anything technical. Plain text is fine. When you're done,
tell me and I'll move all of it into the site.

Leave a slot blank and I'll remove that element entirely rather than invent
something. Blank is always better than my guess.

---

## HOME — the sentence over the collage

One or two lines. Currently: "I'm Nate Horowitz, 2nd year Mechanical
...
## CONTACT — the line under the heading
...
- **Title** — the label on the tile. These came from your Webflow site, so
  they're already yours. Change any you want.
- **Intro** — one or two sentences at the top of the project page.
- **Body** — the write-up. As long or short as you like. Blank line between
  paragraphs.
...
**Photos:** none yet — this page has no images. If you export the topology
study from SolidWorks, save it as `public/images/rocker.png` and it'll appear
on the tile and the page.
